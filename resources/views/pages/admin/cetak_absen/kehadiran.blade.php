	...
	<section class="content">
		<div class="nav-tabs-custom">
			<ul class="nav nav-tabs">
				...
				<li class="active"><a href="{{ route('admin.cetak_absen.kehadiran') }}">Cek Kehadiran</a></li>
	...
	<script type="text/javascript">
		$(document).ready(function () {
			$('select[name="id_matkul"]').on('change', function (e) {
				...
				if (id_matkul !== '') {
					window.open("{{ route('admin.cetak_absen') }}/" + id_kelas + "/" + id_matkul + "/" + semester + "/detail", '_blank');
				}
			});
		});
	</script>

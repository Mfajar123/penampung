@if (empty($is_edit))
	{!! Form::open(['method' => 'PATCH', 'route' => ['admin.absensi.absensi', $kelas->id_kelas, $matkul->id_matkul, $dosen->id_dosen, $jadwal->id_jadwal]]) !!}
@else
	{!! Form::open(['method' => 'PATCH', 'route' => ['admin.absensi.absensi_edit', $kelas->id_kelas, $matkul->id_matkul, $dosen->id_dosen, $jadwal->id_jadwal, $tanggal, $pertemuan_ke]]) !!}
@endif
						...
						<tr>
							...
							<td>
								<div class="radio-inline">
									<label>{!! Form::radio('keterangan['.@$mahasiswa->nim.']', 'Hadir', ! empty($is_edit) ? @$mahasiswa->keterangan == 'Hadir' : TRUE) !!} Hadir</label>
								</div>
							</td>
							<td>
								<div class="radio-inline">
									<label>{!! Form::radio('keterangan['.@$mahasiswa->nim.']', 'Alpha', ! empty($is_edit) ? @$mahasiswa->keterangan == 'Alpha' : FALSE) !!} Tidak Hadir</label>
								</div>
							</td>

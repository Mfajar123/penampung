          ...
          <div class="col-md-12 col-xs-12">
            <div class="row">
              <div class="table-responsive">
                {!! Form::open(['method' => 'POST', 'route' => ['admin.dispensasi.perbarui', $id, $dp]]) !!}
                <table class="table table-striped table-hover">
                  ...
                  <tr>
                    ...
                    <td><input type="text" class='form-control money' name="nominal_akan_bayar" value="{{ $daftar->nominal_akan_bayar }}" required style="width:30%;"  ></td>
                  </tr>

                  <tr>
                    <td style="vertical-align: middle">Tanggal Akan Bayar</td>
                    <td style="vertical-align: middle">:</td>
                     <td><input type="text" class='form-control datepicker' name="tanggal_akan_bayar" value="{{ date('d-M-Y', strtotime($daftar->tanggal_akan_bayar)) }}" required style="width:30%;"  ></td>
                  </tr>

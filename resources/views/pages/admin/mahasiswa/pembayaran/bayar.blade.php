      ...
      @include('_partials.flash_message')
  		<div class="box box-default">
  			<div class="box-header with-border">
  				<h3 class="box-title">Bayar Kelulusan Mahasiswa
          </h3>
  			</div>
          ...
          <div class="col-md-12 col-xs-12">
            <div class="row">
              <div class="table-responsive">
                {!! Form::open(['method' => 'POST', 'route' => ['admin.pembayaran_kelulusan.perbarui', $id, $dp]]) !!}
                ...
                <div class="form-group">
                  <a href="{{ route('admin.pembayaran_kelulusan') }}" class="btn btn-default btn-sm"> Kembali</a>

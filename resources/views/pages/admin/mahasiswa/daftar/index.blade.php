          ...
          @include('_partials.flash_message')
      		...
      		<div class="box box-default">
      			...
      			<div class="box-header with-border">
      				...
      				<h3 class="box-title">List Pendaftaran Mahasiswa | <a href="{{ route('admin.daftar.trash') }}" class="text-primary">Trash</a>

              </h3>

                <a href="{{ route('admin.daftar.tambah') }}" class="btn btn-primary btn-sm pull-right" title="Tambah"><i class="fa fa-plus"></i></a>
              ...
              <div class="col-md-12 col-xs-12">
                ...
                <div class="row">
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-striped daftar">
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
       ...
       var table =  $(".daftar").DataTable({
            ...
            ajax: "{{ route('admin.daftar.datatable') }}",
        ...
        $('#btnCari').click(function(){
          ...
          var url = "{{ route('admin.daftar.datatable') }}?tahun_akademik=" + tahun_akademik + "&id_prodi=" + id_prodi;

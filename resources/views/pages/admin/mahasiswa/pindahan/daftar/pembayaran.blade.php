              ...
              <div class="col-md-12 col-xs-12">
                <div class="row">
                  <div class="table-responsive">
                    {!! Form::model($daftar, ['method' => 'POST', 'route' => ['admin.daftar.pindahan.pembayaran.perbarui', $id]]) !!}
                    <table class="table table-striped table-hover">
                      ...
                      <tr>
                      <td style="vertical-align: middle">Tanggal Pembayaran</td>
                      <td style="vertical-align: middle">:</td>
                      <td> {!! Form::text('tanggal_pembayaran', date('d-M-Y', strtotime(\Carbon\Carbon::today())), ['class' => 'form-control datepicker',  'autocomplete' => 'off', 'style' => 'width: 30%']) !!}</td>
                    </tr>

...
<section class="content">
  <div class="row">
      ...
      @include('_partials.flash_message')
  		{!! Form::model($daftar, ['method' => 'POST', 'route' => ['admin.pindahan.registrasi.action', $id], 'files' => 'true']) !!}
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <i class="text-danger">Tanda (*) Harus Diiisi !</i>
            <div class="tab-pane active" id="biodata">
              ...
              <div class="form-group">
                ...
                {!! Form::text('no_ktp', null, ['class' => 'form-control', 'autocomplete' => 'off', 'required']) !!}
              </div>
              ...
              <div class="form-group row">
                <div class="col-md-6">
                  ...
                  {!! Form::select('id_provinsi', $provinsi, null, ['class' => 'form-control select-custom', 'autocomplete' => 'off', 'required']) !!}
                </div>
              ...
              <div class="form-group row">
                <div class="col-md-6">
                  ...
                  {!! Form::text('kelurahan', null, ['class' => 'form-control', 'autocomplete' => 'off', 'required']) !!}
                </div>
          
                <div class="col-md-6">
                  {!! Form::label('kecamatan', 'Kecamatan *', ['class' => 'control-label']) !!}
                  {!! Form::text('kecamatan', null, ['class' => 'form-control', 'autocomplete' => 'off', 'required']) !!}
                </div>
              </div>

              <div class="form-group">
                {!! Form::label('alamat', 'Alamat *', ['class' => 'control-label']) !!}
                {!! Form::textarea('alamat', null, ['class' => 'form-control', 'rows' => '5', 'required']) !!}
              </div>
            ...
            <div class="tab-pane" id="sekolah">
              @if($daftar->status->nama_status == 'Pindahan')
                <div class="form-group">
                  ...
                  {!! Form::text('pt_asal', null, ['class' => 'form-control', 'autocomplete' => 'off', 'required']) !!}
                </div>
              @endif
              ...
              <div class="form-group row">
                <div class="col-md-6">
                  ...
                  {!! Form::text('kabupaten_sekolah', null, ['class' => 'form-control', 'autocomplete' => 'off', 'required']) !!}
                </div>

                <div class="col-md-6">
                  {!! Form::label('id_provinsi', 'Provinsi *', ['class' => 'control-label']) !!}
                  {!! Form::select('id_provinsi', $provinsi, null, ['class' => 'form-control select-custom', 'autocomplete' => 'off', 'style' => 'width:100%', 'required']) !!}
                </div>
              </div>
            ...
            <!-- /.tab-pane -->
            <div class="form-group">
              <a href="{{ route('admin.pindahan.registrasi') }}" class="btn btn-default btn-sm">Kembali</a>

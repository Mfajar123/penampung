      ...
      @include('_partials.flash_message')
  		<div class="box box-default">
  			<div class="box-header with-border">
  				<h3 class="box-title">Form Perubahan Nominal
          </h3>
  			</div>
          ...
          <div class="col-md-12 col-xs-12">
            <div class="row">
              <div class="table-responsive">
                {!! Form::open(['method' => 'POST', 'route' => ['admin.pindahan.pembayaran.perbarui_nominal', $id]]) !!}
                <table class="table table-striped table-hover">
                  ...
                  <tr>
                    <td style="vertical-align: middle">Perubahan Nominal</td>
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>
                      <select name="status_pembayaran" class="form-control select2" style="width: 30%">
                        <option>Pilih</option>

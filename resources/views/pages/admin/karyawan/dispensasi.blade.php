          ...
          <div class="col-md-12 col-xs-12">
            <div class="row">
              <div class="table-responsive">
                {!! Form::open(['method' => 'POST', 'route' => ['admin.pembayaran_kelulusan.dispen', $id]]) !!}
                <table class="table table-striped table-hover">
                  ...
                  <tr>
                    ...
                    <td>{!! Form::text('nominal_akan_bayar', null, ['class' => 'form-control money', 'placeholder' => 'Contoh : 50,000', 'required', 'autocomplete' => 'off', 'style' => 'width: 30%']) !!}</td>
                  </tr>

...
<div class="form-group">
    {!! Form::label('id_role', 'Role Akses', ['class' => 'control-label']) !!}
...
<div class="form-group row">
  ...
  <div class="col-md-6">
    ...
    {!! Form::text('tgl_lahir', @$tgl_lahir, ['class' => 'form-control datepicker', 'placeholder' => 'Tanggal Lahir', 'autocomplete' => 'off']) !!}
  </div>
</div>

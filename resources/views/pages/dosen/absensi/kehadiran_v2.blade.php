...
<div class="box box-default">
	<div class="box-header with-border">
		<a href="{{ route('dosen.absensi.form_absensi', [$kelas->id_kelas, $matkul->id_matkul, $jadwal->id_jadwal]) }}" class="btn btn-default"><i class="fa fa-check-square-o"></i> Tambah Absensi</a>
	</div>
	<div class="box-body">

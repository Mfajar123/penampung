								...
								@foreach ($mahasiswa as $mahasiswas)
									<tr align="center">
										...
										<td>{{ $mahasiswas->nama }}</td>
											...
											@for($i = 1; $i <= 16; $i++)
												<?php if ( @$bancet[$mahasiswas->nim][$i] == "Hadir" ){  ?>
													<td > H </td>
												<?php   } else if ( @$bancet[$mahasiswas->nim][$i] == "Izin" )  { ?>
												 	<td > I </td>
												<?php  } else if ( @$bancet[$mahasiswas->nim][$i] == "Sakit" )  { ?>
												 	<td > S </td>
											<?php 	 } else if ( @$bancet[$mahasiswas->nim][$i] == "Alpa" )  { ?>
												 	<td > A 	</td>
												<?php }else{   ?>
												 	<td > - </td>
												<?php }?>

                  ...
                  <div class="row">
                    <div class="footerbottom">
                      ...
                      @include('_partials.flash_message')
                        ...
                        {!! Form::open(['method' => 'POST', 'route' => 'web.simpan', 'files' => 'true']) !!}
                          ...
                          <div class="form-group">
                             <p><div class="g-recaptcha" data-sitekey="6Le5eU0UAAAAAH528lJDUlfucXD520ewLsye2KO6"></div></p>
                          </div>
                          <div class="form-group">
                              <button type="submit" name="submit" class="btn btn-primary btn-sm">Kirim Pesan</button>
                      ...
                      <div class="col-md-6 col-xs-12" style="color: black; margin-bottom: 30px;"> 
                        ...
                        <p>SMK PPI Citra Raya Cikupa - Tangerang</p>

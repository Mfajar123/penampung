...
class SMKInfoController extends Controller
{
  ...
  public function datatable(Request $req)
  {
      ...
      foreach ($info as $list)
      {
          ...
          {
              $row['aksi'] =
              '<a href="'.route('smk.admin.info.restore', $list->id_info).'" class="btn btn-success btn-sm" title="Restore" onclick="return confirm('.$restore.')" title="Restore"><i class="fa fa-mail-reply"></i></a>
              <a href="'.route( 'smk.admin.info.hapus.permanent', $list->id_info).'" class="btn btn-danger btn-sm"  title="Hapus Permanen"onclick="return confirm('.$hapus.')" title="Hapus Permanen"><i class="fa fa-trash-o"></i></a>';
          }
          else
          {
              $row['aksi'] =
              '
              <a href="'.route('smk.admin.info.detail', $list->id_info).'" class="btn btn-info btn-sm" title="Detail"><i class="fa fa-search"></i></a>
              <a href="'.route('smk.admin.info.ubah', $list->id_info).'" class="btn btn-warning btn-sm" title="Ubah"><i class="fa fa-edit"></i></a>
              <a href="'.route('smk.admin.info.hapus', $list->id_info).'" class="btn btn-danger btn-sm" title="Hapus" onclick="return confirm('.$toTrash.')"><i class="fa fa-trash-o"></i></a>';
          }
  ...
  {
      return view('pages.smk.admin.info.trash');
  }
  ...
  public function tambah()
  {
     $kategori = SMKKategoriInfo::pluck('kategori_info', 'id_kategori_info');
      return view('pages.smk.admin.info.tambah', compact('kategori'));
  }
  ...
  public function simpan(Request $request)
  {
    ...
    if ($request->hasFile('foto_info')) {
      ...
      return redirect()->route('smk.admin.info');
  }
    ...
    public function detail($id)
    {
        ...
        return view('pages.smk.admin.info.detail', compact('info'));
  ...
  public function restore($id)
  {
      ...
      return redirect()->route('smk.admin.info.trash');
  }
  ...
  public function ubah($id)
  {
      $info = SMKInfo::find($id);
      $kategori = SMKKategoriInfo::pluck('kategori_info', 'id_kategori_info');
      return view('pages.smk.admin.info.ubah', compact('info', 'kategori', 'id'));
  }

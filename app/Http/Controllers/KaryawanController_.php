...

{
...

    {
...

        {
...

            {
                ...
                <a href="'.route( 'admin.karyawan.hapus.permanen', $list->id_admin).'" class="btn btn-danger btn-sm" onclick="return confirm('.$hapus.')" title="Hapus Permanen"><i class="fa fa-trash-o"></i></a>';
...

            {
                ...
                <a href="'.route('admin.karyawan.hapus', $list->id_admin).'" class="btn btn-danger btn-sm" onclick="return confirm('.$toTrash.')"><i class="fa fa-trash-o"></i></a>';
...

    {
        ...
        return view('pages.admin.karyawan.ubah', compact('karyawan', 'id'));
